\documentclass[UTF8]{article}
                ...
                % ===== 统一命名的占位符 =====
                \newcommand{\studentid}{ 201300068}  % 学号
\newcommand{\studentname}{ 李鑫澎}  % 姓名
\newcommand{\username}{ 李鑫澎 }  % 用户名
\newcommand{\papertitle}{基于隔离分布核函数的}  % 论文标题
...
\newcommand{\levelScoreTwoA}{\checkmark}\newcommand{\levelScoreTwoB}{}\newcommand{\levelScoreTwoC}{}\newcommand{\levelScoreTwoD}{}
\newcommand{\levelScoreThreeA}{\checkmark}\newcommand{\levelScoreThreeB}{}\newcommand{\levelScoreThreeC}{}\newcommand{\levelScoreThreeD}{}
\newcommand{\levelScoreFourA}{\checkmark}\newcommand{\levelScoreFourB}{}\newcommand{\levelScoreFourC}{}\newcommand{\levelScoreFourD}{}
...
\newcommand{\qualityScoreThreeA}{\checkmark}\newcommand{\qualityScoreThreeB}{}\newcommand{\qualityScoreThreeC}{}\newcommand{\qualityScoreThreeD}{}
\newcommand{\totalScore}{90}  % 总评分
\newcommand{\suggestions}{ \par[关键词]关键词之间应使用"；"分开\par \par \par \par未发现需要修改的问题。}  % 修改建议
